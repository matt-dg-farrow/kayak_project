...
class CustomerTest {
	...
	void customerTest() {
		...
		assertEquals(
				"Customer [id=null, custFirstName=Bill, custSurname=Billy, emergFirstName=Bob, emergSurname=Bobby, contactNumber=07779123456, emergRelation=Friend, equipment=null]",
				cust1.toString());
